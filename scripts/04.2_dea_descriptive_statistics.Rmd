...
df_br_stat_jan_may %>% 
  ...
  save_kable(file = "./data/figures/br_stats_january_may.pdf")
...
df_br_stat_mar_may %>% 
  ...
  add_header_above(c(" " = 2, "Average" = 2, 
                     "Standard deviation" = 2,
                     "Coefficient of variation" = 2)) %>% 
  save_kable(file = "./data/figures/br_stats_march_may.pdf")
```
