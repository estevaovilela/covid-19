...
df_br_stat_jan_apr %>% 
  ...
  save_kable(file = "./data/figures/br_stats_january_april.pdf")
...
df_br_stat_mar_apr %>% 
  ...
  add_header_above(c(" " = 2, "Average" = 2, 
                     "Standard deviation" = 2,
                     "Coefficient of variation" = 2)) %>% 
  save_kable(file = "./data/figures/br_stats_march_april.pdf")
```
